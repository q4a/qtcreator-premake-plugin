...
--
-- Modified by Konstantin Tokarev for PremakeProjectManager
--
	...
	function doembed()
		...
		for i,fn in ipairs(scripts) do
			print(fn)
			local s = stripfile("premake/src/" .. fn)
			writefile(out, fn, s)
		end
